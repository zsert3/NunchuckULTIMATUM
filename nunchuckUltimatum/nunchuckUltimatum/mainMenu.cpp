...
void drawMenuScherm(MI0283QT9 lcd, int colour1, int colour2, int tekstColour)
{
	...
	lcd.fillRoundRect(40, 70, 160, 40, 10, colour2);
	lcd.drawText(80, 87, "START GAME", tekstColour, colour2, 1);
	lcd.fillRoundRect(40, 150, 160, 40, 10, colour2);
	lcd.drawText(83, 167, "HIGHSCORE", tekstColour, colour2, 1);
	lcd.fillRoundRect(40, 230, 160, 40, 10, colour2);
...
void touchScreen(MI0283QT9 lcd, int colour1, int colour2, int tekstColour)
{
	if (lcd.touchRead())
	{
		...
		{
			pushed = 1;
			lcd.fillRect(40, 150, 160, 40, colour1);
			lcd.drawText(83, 167, "HIGHSCORE", tekstColour, colour1, 1);
		...
		{
			pushed = 1;
			lcd.fillRect(40, 230, 160, 40, colour1);
			lcd.drawText(87, 248, "TUTORIAL", tekstColour, colour1, 1);
			basisschermTutorial(lcd, colour1, colour2, tekstColour);
			terugButton(lcd, colour1, colour2, tekstColour);
		}
		if (pushX >= 40 && pushX <= 200 && pushY >= 290 && pushY <= 320 && pushed == 1)
		{
			lcd.fillRect(10, 290, 220, 30, colour1);
			lcd.drawText(100, 300, "Terug", tekstColour, colour1, 1);
